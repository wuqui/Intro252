...
2. [**Fundamentals**](#language-as-a-tool-for-communication): What is language and how do linguists study it?
3. [**Core concepts**](#the-model-of-the-linguistic-sign-desaussure1916cours): How do words get their meaning?
4. [**Linguistic domains**](#linguistic-domains): What are the core areas of linguistic analysis?
5. [**Applied fields**](#applied-fields): How is linguistics used in real-world applications?
...
|-------------------------------------------|--------------------------|---------------------------------------------------------|
| 1. traffic light colours                  | [symbol]{.excl .fragment} | [arbitrariness (convention)]{.excl .fragment}            |
| 2. portrait photo                         | [icon]{.excl .fragment}   | [similarity (visual)]{.excl .fragment}                  |
| 3. tree rings for a tree's age            | [index]{.excl .fragment}  | [contiguity (systematic correlation)]{.excl .fragment}   |
| 4. onomatopoeia of the word *click*       | [icon]{.excl .fragment}   | [similarity (acoustic)]{.excl .fragment}                |
| 5. national flag of Japan for the country | [symbol]{.excl .fragment} | [arbitrariness (convention)]{.excl .fragment}           |
| 6. wet footprints on the floor            | [index]{.excl .fragment}  | [contiguity (proximity in space/time)]{.excl .fragment} |
...
![](img/disclaimers.excalidraw.svg)
...
![](img/the-old-man-the-boat-ungram.excalidraw.svg)

---

**The sentence is grammatical:**

![](img/the-old-man-the-boat-gram.excalidraw.svg)
