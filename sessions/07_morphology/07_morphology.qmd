...
format:
  html:
    output-file: index_sol.html
  clean-revealjs:
    output-file: slides_sol.html
    css:
      - ../../slides.css
format-links: false
---
...
[Open slides](slides_sol.html){.btn .btn-primary}
:::
...
1. *signpost*: [{sign}~lx.fr~ {post}~lx.fr~]{.sol .fragment}
2. *cats*: [{cat}~lx.bd~ {plural}~gr.bd~]{.sol .fragment}
3. *they*: [{they}~gr.fr~]{.sol .fragment}
4. *singer*: [{sing}~lx.fr~ {er}~lx.bd~]{.sol .fragment}
5. *finger*: [{finger}~lx.fr~]{.sol .fragment}
6. *funnier*: [{funny}~lx.fr~ {er}~gr.bd~]{.sol .fragment}
7. *undeniable*: [{un}~lx.bd~ {deny}~lx.fr~ {able}~lx.bd~]{.sol .fragment}
...
1. *greenhouse*: [endocentric]{.sol .fragment}
2. *knee-deep*: [endocentric]{.sol .fragment}
3. *pot head*: [exocentric]{.sol .fragment}
4. *Alsace-Lorraine*: [copulative]{.sol .fragment}
...
1. *childhood*: [derivation / suffixation]{.sol .fragment}
2. *paperback*: [compounding / exocentric]{.sol .fragment}
3. *study-bedroom*: [compounding / copulative]{.sol .fragment}
4. *foreigner*: [derivation / suffixation]{.sol .fragment}
5. *paleface*: [compounding / exocentric]{.sol .fragment}
6. *Oxbridge*: [blending]{.sol .fragment}
7. *CGEL*: [initialism]{.sol .fragment}
...
1. *to enthuse*: [**back-formation** from *enthusiasm*: N>V]{.sol .fragment}  
2. *laser*: [**acronymisation** from *Light Amplification by Stimulated Emission of Radiation*]{.sol .fragment}  
3. *lab*: [**clipping** from *laboratory* N>N]{.sol .fragment}  
4. *Hinglish*: [**blending** of *Hindi*^n^ and *English*^n^]{.sol .fragment}  
5. *BBC*: [**alphabetism** of *British Broadcasting Corporation*]{.sol .fragment}  
6. *sext*: [**blending** of *sex*^n^ and *text*^n^]{.sol .fragment}  
7. *to hoover*: [**(N) coinage** after American industrialist H. W. Hoover (1849–1932), then **conversion** N>V]{.sol .fragment}
