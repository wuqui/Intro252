...
- **Organisation** — Course logistics and tutorials
- **Introduction to pragmatics** — Context-dependent meaning vs semantics
- **Deixis** — Context-anchoring linguistic devices
- **Speech act theory** — Austin's theory and illocutionary acts
- **Indirect speech acts** — Inferring meaning beyond literal content
- **Cooperative principle and conversational maxims** — Grice's theory and implicatures
- **Summary and outlook** — Recap and preview
...
“The basic idea which underlies Grice’s Cooperative Principle is that communicating is cooperative behaviour, and that therefore every communicative event proceeds on the assumption that speaker and hearer (or author and reader) want to cooperate – even if at first sight this might not seem to be the case.” [@Kortmann2020Essentials: 184]
