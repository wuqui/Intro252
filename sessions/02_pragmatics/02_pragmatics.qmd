...
1. *I hereby christen you Marie Claire.*: [**Declarative**]{.excl .fragment}
2. *I apologise for this awful mess.*: [**Expressive**]{.excl .fragment}
3. *You are under arrest.*: [**Declarative**]{.excl .fragment}
4. *Shall I get you some water?*: [**Directive**]{.excl .fragment}
5. *I claim that this theory needs revision.*: [**Assertive**]{.excl .fragment}
6. *Congratulations on your appointment.*: [**Expressive**]{.excl .fragment} 
7. *Our team has won the competition.*: [**Assertive**]{.excl .fragment}
8. *I'm sorry that I could not come to your birthday party!*: [**Expressive**]{.excl .fragment}
9. *Thank you for taking care of my daughter.*: [**Expressive**]{.excl .fragment}
10. *Good job, Claire!*: [**Expressive**]{.excl .fragment}

---

11. *You are fired.*: [**Declarative**]{.excl .fragment}
12. *Be quiet, Jaye.*: [**Directive**]{.excl .fragment}
13. *I name this ship 'Fortune'.*: [**Declarative**]{.excl .fragment}
14. *One more step, and I'll call the police.*: [**Directive**]{.excl .fragment}
15. *Come to visit us tomorrow.*: [**Directive**]{.excl .fragment}
16. *I am sorry that I could not come to your birthday party!*: [**Expressive**]{.excl .fragment}
17. *I'll bring you a map of London.*: [**Commissive**]{.excl .fragment}
18. *I hereby pronounce you husband and wife.*: [**Declarative**]{.excl .fragment}
19. *I refuse to answer this question.*: [**Commissive**]{.excl .fragment}
20. *Could you please show me the way?*: [**Directive**]{.excl .fragment}
...
1. **A:** *Did you finish your homework?*  
   **B:** *I started it at 3pm, then I had a snack, then I watched some TV, then I went back to it, then I had dinner, then I worked on it some more...*\
   --> [**Quantity** (too much information). Implicature: I didn't finish it.]{.excl .fragment}

2. **A:** *What time is it?*  
   **B:** *Yes.*\
   --> [**Relation** (irrelevant answer). Implicature: I don't know what time it is.]{.excl .fragment}

3. **A:** *How was your date last night?*  
   **B:** *The restaurant had excellent lighting.*\
   --> [**Relation** (irrelevant answer). Implicature: I don't know how the date went.]{.excl .fragment}
...
4. **A:** *Can you help me move this weekend?*  
   **B:** *I have a very important appointment with my dentist's receptionist's cousin's dog walker.*\
   --> [**Quantity** (too much information). Implicature: I don't want to help you move.]{.excl .fragment}

---

5. **A:** *Do you know where Sarah is?*  
   **B:** *She's either in the library, at home, at the gym, or somewhere else.*\
   --> [**Quantity** (too much information). Implicature: I don't know where Sarah is.]{.excl .fragment}

6. **A:** *What did you think of the presentation?*  
   **B:** *It was... interesting.*\
   --> [**Quantity** (too much information). Implicature: I don't know what I think of the presentation.]{.excl .fragment}
...
7. **A:** *Will you be at the meeting tomorrow?*  
   **B:** *I might be there, or I might not be there, depending on various factors that may or may not occur.*\
   --> [**Quantity** (too much information). Implicature: I don't know if I will be at the meeting tomorrow.]{.excl .fragment}

8. **A:** *How much does this cost?*  
   **B:** *It's not free.*\
   --> [**Quantity** (too much information). Implicature: I don't know how much this costs.]{.excl .fragment}
