...
- For instance, voiceless plosives may well be aspirated in the final position of a syllable or word, too, as in [læp] and [læph] for lap, or [ʃʌt] and [ʃʌth] for shut. 
...
::: {.notes}
**10:35–10:50** (15 min) — **KEEP THIS!**

Students LOVE these interactive quizzes!
...
## Minimal Pairs Quiz (Reference) {.small}

**Question types:**

1. **Are these minimal pairs?** (4 questions)
   - *bit* – *bat*: YES (differ only in /ɪ/ vs /æ/)
   - *cat* – *dog*: NO (differ in multiple sounds)
   - *ship* – *sheep*: YES (differ only in /ɪ/ vs /iː/)
   - *pen* – *pan*: YES (differ only in /e/ vs /æ/)

2. **Which is a minimal pair?** (3 questions)
   - *pat* – *bat* vs *cat* – *dog*: Answer *pat* – *bat*
   - *fan* – *van* vs *tree* – *house*: Answer *fan* – *van*
   - *rope* – *robe* vs *tree* – *house*: Answer *rope* – *robe*

3. **What sound differs?** (5 questions)
   - Examples: *sip* vs *ship*, *cap* vs *cup*, *ten* vs *den*, *cod* vs *cord*, *bit* vs *beat*
...
Brief mention - distinctive features are an alternative way to describe phonemes.
:::

---

::: {.notes}
**10:52–10:57** — **BREAK (5 min)**
...
**Note:** Open syllables end in a vowel; closed syllables end in a consonant.
...
### Distinctive word stress

![@Kortmann2020Essentials: 41](att/distinctive-word-stress.png)

::: {.notes}
**11:07** (< 1 min)

Quick visual - noun/verb stress pairs.
:::
...
Work through examples. This is important - assimilation is a key concept.
:::
...
- The realisation of the morpheme {in-} is **phonologically conditioned** by the following sound:
  - *inadequate* [ɪn-]: /n/ occurs elsewhere (before vowels or alveolars)
...
End-of-session review quiz - students love it!
...
- Great way to consolidate learning before moving to syntax next week
:::
